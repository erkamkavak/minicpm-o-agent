...
```python
from minicpmo_demo.core.processors import ChatProcessor
...
from minicpmo_demo.core.capabilities import ProcessorMode, ProcessorCapabilities, CAPABILITIES
    ...
    **为什么使用 Mixin？**
    ...
    def _convert_content_to_model_format(self, content):
        ...
        Returns:
            模型可接受的内容格式（列表）
        """
        from minicpmo_demo.core.schemas import TextContent, ImageContent, AudioContent, VideoContent
        import numpy as np
    ...
    def _convert_messages_to_model_format(
        ...
        """
        from minicpmo_demo.core.schemas import TTSMode, Role
        ...
        if (tts_config and tts_config.enabled 
            ...
            from minicpmo_demo.model.modeling_minicpmo import MiniCPMO
