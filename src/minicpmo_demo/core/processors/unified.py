...
if TYPE_CHECKING:
    from minicpmo_demo.model.modeling_minicpmo_unified import MiniCPMO, ProcessorMode as ModelProcessorMode
    ...
    def streaming_generate(
        ...
        try:
            ...
            for item in iter_gen:
                ...
                from minicpmo_demo.core.schemas.streaming import StreamingChunk
    ...
    def _chat_impl(
        ...
        if generate_audio and tts_config:
            ...
            if tts_config.sampling:
                from minicpmo_demo.model.runtime.tts_streaming import TTSSamplingParams as ModelTTSSamplingParams
...
class DuplexView:
    ...
    def offline_inference(self, task_input: "DuplexOfflineInput") -> "DuplexOfflineOutput":
        ...
        """
        from minicpmo_demo.core.schemas.duplex import DuplexOfflineInput, DuplexOfflineOutput, DuplexChunkResult
        import librosa
...
class UnifiedProcessor(BaseProcessor):
    ...
    def set_chat_mode(self) -> ChatView:
        ...
        Returns:
            ChatView instance.
        """
        from minicpmo_demo.model.modeling_minicpmo_unified import ProcessorMode as ModelProcessorMode
