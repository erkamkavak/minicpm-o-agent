...
from minicpmo_demo.core.schemas.common import Message, Role, TTSConfig, TTSMode
...
# 2. 图像理解
from minicpmo_demo.core.schemas.common import ImageContent, TextContent
request = ChatRequest(
    messages=[
...
# 5. 批量推理
from minicpmo_demo.core.schemas.chat import BatchChatRequest
...
from minicpmo_demo.core.schemas.common import (
    Message,
    TTSConfig,
    GenerationConfig,
    ImageConfig,
