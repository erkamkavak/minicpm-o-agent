...
from minicpmo_demo.core.schemas import ChatRequest, Message, Role
...
# 能力声明
from minicpmo_demo.core.capabilities import (
    ProcessorMode,
...
# 处理器
from minicpmo_demo.core.processors import (
    BaseProcessor,
    UnifiedProcessor,
    ChatView,
    HalfDuplexView,
...
# 工厂
from minicpmo_demo.core.factory import (
    ProcessorFactory,
    create_processor,
)
