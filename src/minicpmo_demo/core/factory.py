...
```python
from minicpmo_demo.core.factory import ProcessorFactory
...
from minicpmo_demo.core.capabilities import ProcessorMode
from minicpmo_demo.core.processors import UnifiedProcessor, ChatView, HalfDuplexView, DuplexView
...
def create_processor(
    ...
    **kwargs
    ...
    示例:
        >>> from minicpmo_demo.core.factory import create_processor
        >>> from minicpmo_demo.core.capabilities import ProcessorMode
