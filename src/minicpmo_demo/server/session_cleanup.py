...
使用方式：
    ...
    - 也可手动调用：
        PYTHONPATH=src python -m minicpmo_demo.server.session_cleanup --data-dir data --retention-days 30 --max-gb 50
"""
...
def cleanup_sessions(
    ...
    sessions_dir = os.path.join(PROJECT_ROOT, data_dir, "sessions")
