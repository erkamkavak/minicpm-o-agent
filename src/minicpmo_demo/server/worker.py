...
启动方式：
    ...
    CUDA_VISIBLE_DEVICES=0 PYTHONPATH=src .venv/base/bin/python -m minicpmo_demo.server.worker \\
        --port 10031 \\
...
from minicpmo_demo.core.schemas.common import Message, Role, TextContent, AudioContent, ImageContent, VideoContent, ContentItem
from minicpmo_demo.core.schemas.chat import ChatRequest, ChatResponse
from minicpmo_demo.core.schemas.streaming import (
    StreamingRequest, StreamingChunk, StreamingResponse, StreamingConfig,
)
from minicpmo_demo.core.schemas.duplex import (
    DuplexConfig, DuplexGenerateResult, DuplexPrefillRequest,
)
from minicpmo_demo.server.session_recorder import DuplexSessionRecorder, TurnBasedSessionRecorder, generate_session_id
...
def _convert_to_model_msgs(schema_messages: List[Message]) -> list:
    ...
    from minicpmo_demo.core.processors.base import MiniCPMOProcessorMixin
...
async def half_duplex_ws(ws: WebSocket):
    ...
    from minicpmo_demo.vad import StreamingVAD, VadOptions
