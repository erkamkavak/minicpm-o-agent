...
Usage:
    ...
    CUDA_VISIBLE_DEVICES=0 PYTHONPATH=src .venv/base/bin/python -m minicpmo_demo.tools.benchmark
    ...
    # With torch.compile
    CUDA_VISIBLE_DEVICES=0 PYTHONPATH=src .venv/base/bin/python -m minicpmo_demo.tools.benchmark --compile
"""
